...
Você → responsável por manter a confidencialidade das suas credenciais de conta. Você concorda em nos notificar imediatamente sobre qualquer uso não autorizado da sua conta. Reservamo-nos o direito de suspender ou encerrar contas que violem estes termos.`,
  },
  {
...
A Plataforma usa inteligência artificial para gerar conteúdo como mensagens, e-mails e textos de anúncios. Você → o único responsável por revisar, editar e aprovar qualquer conteúdo gerado por IA antes do uso. O BMAPZ não garante a precisão, integridade ou adequação do conteúdo gerado por IA.`,
  },
  {
...
A Plataforma integra-se com serviços de terceiros (Google, Meta, LinkedIn, WhatsApp, etc.). O uso dessas integrações está sujeito aos respectivos termos de serviço de terceiros. O BMAPZ não → responsável pela disponibilidade ou funcionalidade de serviços de terceiros.`,
  },
  {
...
O uso da Plataforma também → regido pela nossa Política de Privacidade. Coletamos e processamos dados conforme descrito nela. Ao usar a Plataforma, você consente com esse processamento.`,
  },
  {
...
Qualquer das partes pode encerrar este acordo a qualquer momento. Após o encerramento, seu acesso → Plataforma cessará. Podemos reter seus dados por até 90 dias após o encerramento antes da exclusão, salvo se exigido por lei para retê-los por mais tempo.`,
  },
  {
