...
const INTEGRATIONS = [
  ...
  // ── DESIGN TOOLS ──────────────────────────────────
  {
    ...
    items: [
      { type: 'canva', name: 'Canva', logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/0/08/Canva_icon_2021.svg/512px-Canva_icon_2021.svg.png', description: 'Design social media posts, presentations, and marketing materials', statusKey: 'canva', configKey: null, setupUrl: 'https://www.canva.com/developers/', loginBased: true, easySetup: 'In Canva: Account → Canva for Developers → Create an integration and get your access token.' },
